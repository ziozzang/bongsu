...
func TestAdminMetricsExposeAgentFleetState(t *testing.T) {
	...
	for _, want := range []string{
		...
		"agentFleetOperationalStatus(len(hosts), agentStatusCounts, driftCounts, staleScanRequestCounts, securityDBRescanStaleCounts, s.installToken != \"\", agentInstaller, trivyInstaller)",
