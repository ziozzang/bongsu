...
| `GET` | `/api/vulnerabilities` | List latest-scan CVEs with host/container/owner/team/environment/finding-source/CISA-KEV filters and package type/ecosystem context |
