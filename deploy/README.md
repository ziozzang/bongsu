...
| `BONGSU_CVE_AFFECTED_INDEX_REBUILD_TIMEOUT_SECONDS` | `180` | Startup/admin timeout for rebuilding the derived affected-package index after migrations or manual repair; startup timeout queues async rebuild instead of preventing the API listener from starting |
