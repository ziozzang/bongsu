...
| `GET` | `/api/admin/metrics` | Admin-only Prometheus text metrics for DB pool health, security recalculation state, Trivy readiness, security source freshness, active risk-level backlog, and automatic rescan backlog |
