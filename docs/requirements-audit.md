...
- New schedules, asset groups, reports, notification rules, local sessions, backup/restore, and OpenAPI surfaces have unit/source coverage and docs, but should still be exercised in a realistic operator workflow before a commercial release.
