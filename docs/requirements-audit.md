...
| R11 | Everything must be sufficiently tested. | Partial | Go unit/source tests, Playwright E2E for CVE DB, force scan, and RBAC admin flows; deployment/static/installer/migration verifiers; GitHub Actions CI | CI and local verifier suite; broader live multi-host/container fixtures remain useful |
