...
- Airgap package contents are verified statically, the package script has an end-to-end smoke verifier, and generated archives can now be unpacked and verified with `./scripts/verify-airgap-release-archive.sh`; a full real offline deployment rehearsal should still be exercised before commercial release.
