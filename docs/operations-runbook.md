...
- `bongsu_security_source_registry_ok_sources` lower than `bongsu_security_source_registry_enabled_sources`, nonzero `bongsu_security_source_registry_error`, or missing `bongsu_security_source_registry_records{source="osv",...}`; these expose the persisted source registry that backs the dashboard Source Registry card.
