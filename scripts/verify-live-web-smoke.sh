...
export BONGSU_WEB_BASE="$WEB_URL"
export BONGSU_API_KEY="$API_KEY"
export BONGSU_ADMIN_USERNAME="$ADMIN_USERNAME"
export BONGSU_ADMIN_PASSWORD="$ADMIN_PASSWORD"
export BONGSU_VERIFY_WEB_CVE_QUERY="$CVE_QUERY"
